...
object Dependencies {
  ...
  val akkaActor = "com.typesafe.akka" %% "akka-actor" % "2.3.15" // Apache v2
  val akkaSlf4j = "com.typesafe.akka" %% "akka-slf4j" % "2.3.15" // Apache v2
  val akkaTestkit = "com.typesafe.akka" %% "akka-testkit" % "2.3.15" // Apache v2
